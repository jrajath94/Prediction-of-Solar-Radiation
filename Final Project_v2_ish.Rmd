...
solar = read.csv(file ='C:/Users/ishita/Downloads/solar_radiation_Features_Illinois_Jan-Dec2019v4.csv')
head(solar)
...
xtrain=model.matrix (surface_net_solar_radiation~.,df_solar.train)[,-1]
ytrain=df_solar.train$surface_net_solar_radiation
xtest=model.matrix (surface_net_solar_radiation~.,df_solar.test)[,-1]
...
lasso.pred = predict(lasso.mod, s = bestlam, newx = x[df_solar.test,])
mean((lasso.pred - y[df_solar.test]^2 ))
